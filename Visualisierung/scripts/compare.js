...
function finalCompare() {
        loadCompare("compareViz1", 2, 1, ["data/sphincs.csv", "data/diffie-hellman.csv"]);
        loadCompare("compareViz2", 1, 2, ["data/kyber.csv", "data/diffie-hellman.csv"]);
        load3Compare("compareViz3", 2, 3, 1, ["data/kyber.csv", "data/diffie-hellman.csv", "data/sphincs.csv"]);
        loadCompare("compareViz4", 4, 6, ["data/kyber.csv", "data/diffie-hellman.csv"]);
}
...
async function loadCompare(plot, headerNo1, headerNo2, csvUrls) {
  try {
    ...
    svg
      ...
      .text("seconds"); //  ${yAxisLabel1} / ${yAxisLabel2}
